...
import pl.betacraft.moneh.Moneh;
...
public class Betacraft extends JavaPlugin {
	...
	public void onEnable() {
		...
		//Bukkit.getServer().getPluginManager().registerEvent(Type.PLAYER_JOIN, new PLAYER(), Priority.Normal, this);
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String alias, String[] args) {
		...
		Moneh.onCommand(sender, cmd, alias, args);
